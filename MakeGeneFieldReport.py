...
for k in files:
	if(k[-1:]=='m'):
		...
		if(k!='DrawGF.m'):
			...
			genes[k[0:k2]]+='<img src="./geneFieldsOP/'+k[:-2]+'.jpg" width="800" height="600">\n'
...
for k in genes:
	opHTML+='var CollapsiblePanel'+str(n)+' = new Spry.Widget.CollapsiblePanel("'+k+'", {contentIsOpen:false});\n'
	n+=1
